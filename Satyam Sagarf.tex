...
\resumeSubHeadingListStart
    ...
    \begin{description}[font=$\bullet$]
		\item {Joined with 1 person to build a web application from scratch using Django to get user details to facilitate services.}
		\vspace{-3pt}
...
\resumeSubHeadingListStart
    ...
    {Python, Django, Bootstrap, Javascript \& Postgres}{\href{https://github.com/satyamrs00/pizza}{Github repo}}
    ...
    {React, Redux, Bootstrap, Netlify \& Git}{\href{https://drumzz.netlify.app}{Working link} ~ \href{https://github.com/satyamrs00/drum}{Github repo}}
