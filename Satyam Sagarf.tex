...
\resumeSubHeadingListStart
    ...
    % \href{https://pinopizza.herokuapp.com}{Working link} ~ 
    ...
    % {Python, Django, Bootstrap, Javascript, DBMS \& SQLite}{\href{https://github.com/satyamrs00/network}{Github repo}}
    
    % % \href{https://thisnetwork.herokuapp.com}{Working link} ~ 
